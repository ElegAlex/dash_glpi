...
const SIGNATURE_PHRASES: &[&str] = &[
    ...
    "une solution définitive a été mise en oeuvre pour répondre à votre attente",
    "une solution définitive a été mise en œuvre pour répondre à votre attente",
    "lister les actions",
    "application ou matériel",
