    ...
    <div>
      <header className="sticky top-0 z-10 bg-[#F5F7FA]/80 backdrop-blur-sm px-8 pt-6 pb-4 border-b border-slate-200/30">
        ...
        <p className="text-sm text-slate-400 mt-1">
          Analyse textuelle des solutions — capitalisation du savoir-faire
        </p>
      </header>
        ...
        {mainTab === "keywords" && (
          <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              >
                {analysisHook.loading ? "Analyse en cours..." : "Analyser les solutions"}
              </button>
            </div>
            ...
            {!analysisHook.loading && !result && !analysisHook.error && (
              <EmptyState message="Cliquez sur Analyser les solutions pour lancer l'extraction de mots-cles" />
            )}
